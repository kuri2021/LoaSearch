...
class LoaApi : com.kuri2024.loasearch.api.LoaApiInf {
    companion object {

    }

    val api: com.kuri2024.loasearch.api.LoaApiInterface = Connect().connect().create(com.kuri2024.loasearch.api.LoaApiInterface::class.java)
    ...
    override fun checkApi(api:String,callback: (String) -> Unit) {
        val signUpApi : com.kuri2024.loasearch.api.LoaApiInterface = Connect().signUpConnect(api).create(
            com.kuri2024.loasearch.api.LoaApiInterface::class.java)
